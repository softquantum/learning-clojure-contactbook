...
var G__36049 = cljs.core.next(xs);
var G__36050 = cljs.core.next(ys);
xs = G__36049;
ys = G__36050;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__36034 = val;
var G__36035 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__36034,G__36035) : f.call(null,G__36034,G__36035));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__36036 = val__$1;
var G__36037 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__36036,G__36037) : f.call(null,G__36036,G__36037));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__36038 = val__$1;
var G__36039 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__36038,G__36039) : f.call(null,G__36038,G__36039));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__36059 = cljs.core.next(es);
var G__36060 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__36059;
tcoll__$1 = G__36060;
continue;
} else {
...
var G__36061 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__36062 = cljs.core.next(es);
ret = G__36061;
es = G__36062;
continue;
} else {
