...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__36178_SHARP_,p2__36177_SHARP_){
return p2__36177_SHARP_.toUpperCase();
}));
...
while(true){
if(cljs.core.seq(m)){
var G__36201 = cljs.core.rest(m);
var G__36202 = (function (){var entry = cljs.core.first(m);
...
var G__36186 = o1;
goog.object.extend(G__36186,o2);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36187_SHARP_){
if(cljs.core.map_QMARK_(p1__36187_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__36187_SHARP_);
} else {
return p1__36187_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__36210 = cljs.core.rest(m);
var G__36211 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__36218 = cljs.core.rest(m);
var G__36219 = (function (){var entry = cljs.core.first(m);
