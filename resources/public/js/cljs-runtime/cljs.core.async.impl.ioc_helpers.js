...
if((typeof cljs !== 'undefined') && (typeof cljs.core !== 'undefined') && (typeof cljs.core.async !== 'undefined') && (typeof cljs.core.async.impl !== 'undefined') && (typeof cljs.core.async.impl.ioc_helpers !== 'undefined') && (typeof cljs.core.async.impl.ioc_helpers.t_cljs$core$async$impl$ioc_helpers29003 !== 'undefined')){
} else {
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"f","f",43394975,null),new cljs.core.Symbol(null,"meta29004","meta29004",-205137327,null)], null);
}));
...
(cljs.core.async.impl.ioc_helpers.t_cljs$core$async$impl$ioc_helpers29003.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"cljs.core.async.impl.ioc-helpers/t_cljs$core$async$impl$ioc_helpers29003");
}));

/**
 * Positional factory function for cljs.core.async.impl.ioc-helpers/t_cljs$core$async$impl$ioc_helpers29003.
 */
...
var fexpr__29012 = cljs.core.async.impl.ioc_helpers.aget_object(state,(0));
return (fexpr__29012.cljs$core$IFn$_invoke$arity$1 ? fexpr__29012.cljs$core$IFn$_invoke$arity$1(state) : fexpr__29012.call(null,state));
});
...
var statearr_29023_29057 = state;
(statearr_29023_29057[(2)] = x);

(statearr_29023_29057[(1)] = blk);
...
var statearr_29027_29058 = state;
(statearr_29027_29058[(2)] = cljs.core.deref(cb));

(statearr_29027_29058[(1)] = blk);
...
var statearr_29038_29062 = state;
(statearr_29038_29062[(2)] = ret_val);

(statearr_29038_29062[(1)] = blk);
...
if(cljs.core.truth_(temp__5751__auto__)){
var cb = temp__5751__auto__;
var statearr_29042_29064 = state;
(statearr_29042_29064[(2)] = cljs.core.deref(cb));

(statearr_29042_29064[(1)] = blk);
