...
var G__27627 = request;
var G__27628 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__27627,G__27628) : ajax.formats.get_format.call(null,G__27627,G__27628));
} else {
...
return cljs.core.some((function (p1__27635_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__27635_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__27638){
var map__27639 = p__27638;
var map__27639__$1 = cljs.core.__destructure_map(map__27639);
var request = map__27639__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27639__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__27644 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__27644.cljs$core$IFn$_invoke$arity$1 ? fexpr__27644.cljs$core$IFn$_invoke$arity$1(response) : fexpr__27644.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__27648){
var map__27649 = p__27648;
var map__27649__$1 = cljs.core.__destructure_map(map__27649);
var request = map__27649__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27649__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__27647_SHARP_){
return ajax.formats.get_accept_entries(request,p1__27647_SHARP_);
