...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__27658){
var map__27659 = p__27658;
var map__27659__$1 = cljs.core.__destructure_map(map__27659);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27659__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__27661_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4223__auto__ = p1__27661_SHARP_;
 ...
 */
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__27663){
var map__27664 = p__27663;
var map__27664__$1 = cljs.core.__destructure_map(map__27664);
var request = map__27664__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27664__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
