...
var i_29177 = (self__.level + (1));
while(true){
if((i_29177 <= (new_level + (1)))){
(update[i_29177] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_29180 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29180[i]));
} else {
x__$2.forward.push((((i < links_29180.length))?(links_29180[i]):null));
}

if((i < links_29180.length)){
(links_29180[i] = x__$2);
} else {
links_29180.push(x__$2);
}
...
var i_29192 = (0);
while(true){
if((i_29192 <= self__.level)){
var links_29193 = (update[i_29192]).forward;
if((x__$1 === (((i_29192 < links_29193.length))?(links_29193[i_29192]):null))){
(links_29193[i_29192] = (x__$1.forward[i_29192]));

var G__29196 = (i_29192 + (1));
i_29192 = G__29196;
continue;
} else {
var G__29197 = (i_29192 + (1));
i_29192 = G__29197;
continue;
}
} else {
...
var G__29212 = nx;
var G__29213 = (level__$1 - (1));
x = G__29212;
level__$1 = G__29213;
continue;
} else {
var G__29214 = x;
var G__29215 = (level__$1 - (1));
x = G__29214;
level__$1 = G__29215;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__29236 = nx;
var G__29237 = (level__$1 - (1));
x = G__29236;
level__$1 = G__29237;
continue;
} else {
var G__29244 = x;
var G__29245 = (level__$1 - (1));
x = G__29244;
level__$1 = G__29245;
continue;
}
